...
const roomTypeRadioOptions = [
  {
    ...
    value: "entire",
    description:
      "게스트가 숙소 전체를 다른 사람과 공유하지 않고 단독으로 이용합니다. 일반적으로 침실, 욕시르 부엌이 포함됩니다.",
  },
  {
    label: "개인실",
    value: "private",
  ...
  },
  {
    ...
    value: "public",
    description:
      "게스트는 개인 공간 없이, 다른 사람과 함께 쓰는 침실이나 공용곤간에서 숙박합니다.",
  },
];
...
const RegisterRoomBuilding: React.FC = () => {
  ...
  //* 숙소 유형 변경 시
  const onChangeRoomType = (option: "entire" | "private" | "public") => {
